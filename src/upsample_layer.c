...
{
    printf("I am going in upsample for direct\n");
    fill_cpu(l.outputs*l.batch, 0, l.output, 1);
    if(l.reverse){
	printf("reverse \n");
        upsample_cpu_direct(l.output, l.out_w, l.out_h, l.c, l.batch, l.stride, 0, l.scale, net.input);
    }else{
	printf("forward \n");
        upsample_cpu_direct(net.input, l.w, l.h, l.c, l.batch, l.stride, 1, l.scale, l.output);
    }
}
#else
void forward_upsample_layer(const layer l, network net)
