...
void forward_batchnorm_layer(layer l, network net)
{
    ...
    if(net.train){
        ...
        normalize_cpu_direct(l.output, l.rolling_mean, l.rolling_variance, l.batch, l.out_c, l.out_h*l.out_w);
    }
    scale_bias_direct(l.output, l.scales, l.batch, l.out_c, l.out_h*l.out_w);
    add_bias_direct(l.output, l.biases, l.batch, l.out_c, l.out_h*l.out_w);
}
#else
void forward_batchnorm_layer(layer l, network net)
{
